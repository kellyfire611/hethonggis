...
class DichVu extends Eloquent
{
    ...
    {
        return '<a href="'.route('admin.dichvu.show', $this->id).'" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.view').'" class="btn btn-info"><i class="fas fa-eye"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.dichvu.edit', $this->id).'" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'" class="btn btn-primary"><i class="fas fa-edit"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.dichvu.destroy', $this->id).'"
                data-method="delete"
    ...
    {
      return $this->belongsTo(DiaDiem::class, 'id_diemthamquan', 'id');
    }
}
